...
<p>In late May 2026, rsync blew up. GitHub, Hacker News, Lobsters: hundreds of people arguing about two questions that have been tearing into each other for months. Can you ship AI-written code and call it reliable? And do open-source maintainers owe their users anything beyond the code they give away for free?</p>
...
<p>It spread to <a href="https://news.ycombinator.com/item?id=48342705">Hacker News</a> and <a href="https://lobste.rs/s/k1b0za/rsync_outrage">Lobsters</a>, generating hundreds more comments. On Lobsters, user <code>boramalper</code> wrote:</p>
...
<p>The central claim of the critics is straightforward: <span class="callout-inline">Claude-assisted development introduced bugs into a previously stable tool.</span> On the HN thread, user <code>fao_</code> summarized the argument: <em>"People are very justifiably angry that a very stable, well trusted tool, has started to immediately go downhill… all because the main dev is vibecoding that software."</em></p>

<p>Andrew Tridgell ("tridge"), rsync's lead developer, <a href="https://medium.com/@tridge60/rsync-and-outrage-d9849599e5a0">responded in a Medium post</a> with a different framing. He described a flood of security reports (many AI-generated themselves) that forced rapid, extensive changes to rsync's attack surface. A retired developer who would rather be sailing, he reached for Claude to help with the volume of work: writing test suites, adding defence-in-depth hardening, and working through the CVE backlog. He acknowledged the regressions in v3.4.3 but said he had deliberately prioritized security fixes over edge-case compatibility.</p>
...
<p><strong>This document exists to answer one question with the simplest possible data:</strong> if you place the Claude releases in the distribution of all historical releases, do they stand out? No model. No covariates. Just the empirical distribution of bugs per commit across every release with data.</p>
